    ...
    schema: JSON.stringify([
      {
        ...
        "image": "https://mivizarchitects.in/images/affordable_blueprint_planning_1786199099845.png",
      ...
      },
      {
        ...
        "itemListElement": [
          ...
          },
          {
            "@type": "ListItem",
            "position": 2,
            "name": "Architects in Pune",
            "item": "https://mivizarchitects.in/architects-in-pune"
          }
        ]
      },
      {
        ...
        "mainEntity": [
          ...
          {
            "@type": "Question",
            "name": "Do you handle both architecture and interior design in Pune?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Yes, as a comprehensive architecture firm in Pune, we provide both architectural design and interior design services, ensuring cohesive and harmonious spaces."
            }
          }
        ]
      }
...
<div style="text-align: center; margin: 30px 0;">
            <img src="/images/modern_villa_exterior_1786268542687.png" alt="Modern residential architecture in Pune, showcasing contemporary facade design and sustainable materials." style="max-width: 100%; height: auto; border-radius: 8px; box-shadow: 0 4px 10px rgba(0,0,0,0.1);" />
...
<h2>Redefining Spaces with the Leading Architecture Firm in Pune</h2>
    ...
    <h2>Comprehensive Architectural Services Tailored to You</h2>
    <p>MIVIZ operates as a full-service architecture firm in Pune, handling projects of varying scales and complexities. Our portfolio encompasses a wide spectrum of architectural disciplines, each approached with the same level of rigorous detailing and creative passion.</p>

    <h3>Residential Architecture</h3>
    <p>Your home is your sanctuary. Our <a href="/residential-architects-pune" style="color:#d9a05b; text-decoration:underline;">residential architects in Pune</a> work closely with you to understand your lifestyle, daily routines, and aesthetic preferences. We design homes that are not only visually striking but also deeply intuitive and comfortable. From minimalist urban apartments to expansive <a href="/luxury-villa-design-pune" style="color:#d9a05b; text-decoration:underline;">luxury villas</a> in the outskirts of Pune, our residential architecture prioritizes spatial flow, natural ventilation, and personalized detailing.</p>

    <h3>Commercial and Workspace Architecture</h3>
    <p>The modern workplace requires a dynamic approach to design. As an experienced architecture firm in Pune, we design commercial spaces that foster productivity, encourage collaboration, and reflect your brand's core identity. We understand the nuances of <a href="/commercial-architects-pune" style="color:#d9a05b; text-decoration:underline;">commercial architecture</a>, including space optimization, acoustic management, and integrating the latest smart-building technologies.</p>
...
<div style="text-align: center; margin: 30px 0;">
            <img src="/images/outdoor_patio_firepit_1786269064482.png" alt="Completed turnkey residential villa project in Pune highlighting flawless civil construction and elevation design." style="max-width: 100%; height: auto; border-radius: 8px; box-shadow: 0 4px 10px rgba(0,0,0,0.1);" />
